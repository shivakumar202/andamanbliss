@extends('layouts.app')
@section('title', 'Andaman Tour Packages from Ahmedabad | Ahmedabad to Andaman Nicobar Trips')
...
@section('description', 'Discover Andaman Tour Packages from Ahmedabad with flights, resorts, island tours and water activities. Explore Port Blair, Havelock and Neil with flexible itineraries.')
@push('styles')
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="faq-header mb-5">
                    ...
                    <p class="faq-subtitle">Everything you need to know about planning your trip to Andaman Islands From Ahmedabad</p>
                </div>
            </div>
        </div>
