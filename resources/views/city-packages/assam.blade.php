@extends('layouts.app')
@section('title', 'Andaman Tour Packages from Assam | Assam to Andaman Nicobar Trips')
@section('keywords', 'Andaman package from Assam, Andaman tour package from Assam, best time to visit Andaman island, Top Places You Can Experience in Andaman Island, How to Reach Andaman island from Assam. ')
@section('description', 'Experience Andaman Tour Packages from Assam with hotels, transfers, cruises and sightseeing. Explore Port Blair, Havelock and Neil with personalized itineraries.')
        ...
        <div class="row">
            <div class="col-12">
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">
                        Andaman Tour Package from Assam<span class="highlight">| Andaman Bliss Deals<span>                     
                    </h1>
                    <p class="hero-subtitle">
                    Discover Andaman island with our Assam to Andaman tour package. Explore pristine beaches, thrilling water sports and have hassle free travel with customized holiday packages.</p>
            ...
            <div class="col-lg-12">
                <div class="intro-content"
                    ...
                    <h2
                        ...
                        Best Andaman Tour Package from Assam <span style="color: #fd7e14;">| Beaches & Adventure</span> 
                    </h2>
                    <div>
                      ...
                      The Andaman island offers pristine beaches, crystal clear water and peaceful surroundings that are perfect for families, friends and honeymooners. You can reach via connecting flight from Guwahati to Port Blair. Our <strong>Andaman package from Assam</strong> basically includes all the popular destinations like <a href="https://andamanbliss.com/islands/havelock-swaraj-dweep/radhanagar-beach" target="_blank">Radhanagar</a> and Elephant beach, <a href="https://andamanbliss.com/islands/neil-shaheed-dweep/laxmanpur-beach" target="_blank">Laxmanpur</a> and Bharatpur beach, historic <a href="https://andamanbliss.com/islands/port-blair/cellular-jail" target="_blank">Cellular Jail</a>, Ross & North Bay island and <a href="https://andamanbliss.com/islands/baratang/lime-stone-caves" target="_blank">Limestone cave</a> and Mud volcano. You can also take part in many <a href="https://andamanbliss.com/activities/" target="_blank">thrilling activities</a> like snorkeling, scuba diving, sea walking and Jet skiing. Visit Andaman island during the month of October to May, as it offers pleasant weather and calm seas. Our <strong>Andaman Bliss</strong> package offers customizable itineraries, comfortable accommodation, transfers, sightseeings and inter island ferry transfers. So you just need to arrive and start your unforgettable Andaman adventure. 

                    </p>
                    </div>
                    <a href="#" id="readMoreToggle" class="read-more-toggle">Read More</a>
                    <div id="readMoreContent" class="read-more-content">
                        <h3 class="fs-6 mt-3 fw-bold">Plan Your Dream Andaman Trip from Assam | Unforgettable Experience 
                        </h3>
                        <p style="color: #666; font-size: 0.95rem; line-height: 1.6; margin-bottom: 15px; text-align:justify">Do you want to explore a destination where clear blue waves meet soft white sandy beaches?  Our <strong>Andaman tour package from Assam</strong> gives you the chance to enjoy the beauty of the island without any worry. You can walk on the soft sandy beaches, swim in crystal clear water and relax on the calm and peaceful beaches of Andaman island. Whether you are going with your <strong>family</strong>, <strong>friends</strong> or for a <strong>honeymoon</strong>, Andaman island is the perfect spot to make happy memories.</p>

                        <h3 class="fs-6 fw-bold mt-2">Why Book Your Andaman Tour Package With Andaman Bliss?</h3>
                        <ul class="packages-list-style mb-3">
                            <li><strong>Personalized Itineraries:</strong> Our package can be customized as per your style and preferences.</li>
                            <li><strong>Budget friendly to Luxury Packages:</strong> We have a wide range of package options that will suit every type of traveler.</li>
                            <li><strong>Trusted by thousands of happy travelers:</strong> We have a proven record of delivering thousands of memorable experiences.</li>
                            <li><strong>Seamless Travel Experience:</strong> We are a professional that handles hotels, transfers, ferries and sightseeing so you can just relax and enjoy.</li>
                            <li><strong>Special deals and discounts:</strong> We do offer special offers for families, honeymooners and group travelers.</li>
                            <li><strong>Transparency and no hidden cost:</strong> What you see is what you pay, with no extra cost and inclusions.</li>
                        </ul>
                       
                        <h3 class="fs-6 fw-bold">How to Reach Andaman island from Assam</h3>
                        <strong>By Air:</strong> 
                        <ul class="packages-list-style">
                           <li> The most easy and convenient way to reach Andaman island is by taking a connecting flight from Guwahati to Port Blair via Kolkata or Chennai.</li>
                            <li> Travel time is around 5 to 6 hours depending on the layover.</li>
                            <li>Once you reach Port Blair, everything will be taken care of by our Andaman Bliss team from hotel, ferry transfers to island hopping and guided tours.</li>
                        </ul>
                                               
                        <h3 class="fs-6 fw-bold mt-3">Best Time to Visit Andaman Island from Assam</h3>
                        <ul class="packages-list-style">
        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="faq-header mb-5">
                    ...
                    <p class="faq-subtitle">Everything you need to know about planning your trip to Andaman Islands From Assam</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-6">
                <div class="faq-item" id="faq1">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer1"
                        ...
                        <h3>How can I travel  to Andaman island from Assam?</h3>
                    ...
                    <div class="faq-answer collapse show" id="faqAnswer1" style="">
                        <p>The best and the fastest way to reach Andaman island from Assam is by flight. You can take a connecting flight from Guwahati to Port Blair via Kolkata or Chennai. The travel time will be around 5 to 6 hours depending on the layover.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq2">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer2"
                        ...
                        <h3>What is the cost of an Andaman tour package from Assam?</h3>
                        <div class="faq-toggle">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus"></i>
                        </div>
                    ...
                    <div class="collapse faq-answer" id="faqAnswer2">
                        <p>The cost of an average Andaman tour package from Assam basically depends on few factors like accommodation, length of your stay, activities and additional inclusion you want to include in your package. On average, the package usually starts from INR 18,000 to INR 25,000 per person for a 4 to 5 day trip and the cost goes higher for the luxury package.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq3">
                    ...
                    <div class="collapse faq-answer" id="faqAnswer3">
                        <p>We suggest you to visit Andaman island from October to May. During these month, the weather is pleasant, the seas are calm and all the water sport activities are open. The Monsoon month that starts from June to September are less ideal due to heavy rain and rough sea condition.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq5">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer5"
                        ...
                        <h3>What are the top best places to visit in Andaman island?</h3>
                        <div class="faq-toggle">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus"></i>
                        </div>
                    ...
                    <div class="collapse faq-answer" id="faqAnswer5">
                        <p>Our Andaman tour package basically includes Port Blair, Havelock island and Neil island where you can enjoy Cellular Jail, Ross & North Bay island, Radhanagar & Elephant beach, Laxmanpur beach & Natural rock bridge and Limestone cave. You can even customize your itinerary as per your preferences and choice.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq6">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer6"
                        ...
                        <h3>Is Andaman island a good destination for families and honeymooners travelling from Assam?</h3>
                        <div class="faq-toggle">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus"></i>
                        </div>
                    ...
                    <div class="collapse faq-answer" id="faqAnswer6">
                        <p>Yes, Andaman island is one of the most preferred destinations for every type of traveler. When it comes to family, you can enjoy the safe beaches, sightseeing and nature tours. But when we talk about couples, you can enjoy the romantic sunsets, private beachside stays and adventure activities.</p>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="faq-item" id="faq4">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer4"
                        ...
                        <h3>How many days are enough for an Andaman trip from Assam?</h3>
                        <div class="faq-toggle">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus"></i>
                        </div>
                    ...
                    <div class="collapse faq-answer" id="faqAnswer4">
                        <p>A 5 to 7 days trip is more than sufficient to explore the major attractions in Port Blair, Havelock and Neil island. But if you want to explore offbeat destinations, then 8 to 10 day trip would be perfect for you.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq7">
                    ...
                    <div class="collapse faq-answer" id="faqAnswer7">
                        <p>No, flight tickets are not included in our Andaman tour package, we fully focus on ground handling arrangements like hotel, sightseeing, ferries and activities. So you need to book your flight tickets by your own and once you land in Port Blair, our team will take care of every logistics.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq8">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer8"
                        ...
                        <h3>What activities are included in an Andaman tour package?</h3>
                        <div class="faq-toggle">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus"></i>
                        </div>
                    ...
                    <div class="collapse faq-answer" id="faqAnswer8">
                        <p>We do offer complimentary snorkeling sessions where you can explore the underwater world. But beside these, there are also a lot of activities that you can enjoy in Andaman island which are scuba diving, sea walking, jet skiing and glass bottom boat rides etc. You can book your preferred activities from our own website as well.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq9">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer9"
                        ...
                        <h3>Do I need to carry a passport for visiting Andaman island from Assam?</h3>
                        <div class="faq-toggle">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus"></i>
                        </div>
                    ...
                    <div class="collapse faq-answer" id="faqAnswer9">
                        <p>No, Indian citizens do not have to carry a passport or visa to visit Andaman island. You just need to carry a valid government ID issued card such as Aadhaar card or driving license as it may be required at the time of airport and hotel check ins.</p>
                    </div>
                </div>
                <div class="faq-item" id="faq10">
                    <div class="faq-question" data-bs-toggle="collapse" data-bs-target="#faqAnswer10"
                        ...
                        <h3>Can I customize my Andaman package from Assam?</h3>
                        <div class="faq-toggle">
                            <i class="fas fa-plus"></i>
                            <i class="fas fa-minus"></i>
                        </div>
                    ...
                    <div class="collapse faq-answer" id="faqAnswer10">
                        <p>Yes, our packages are fully customizable. You can choose your preferred hotel, activities and the number of days you want to stay in Andaman island.</p>
                    </div>
                </div>
            </div>
        </div>
