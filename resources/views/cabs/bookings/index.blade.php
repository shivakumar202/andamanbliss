            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="filter-section">
                        ...
                        <!-- Price Range -->
                        <h6>Price Range (₹)</h6>
                        <input type="range" class="form-range" min="500" max="5000" value="2000">
                        <small class="text-muted">₹500 - ₹5000</small>
                        <hr class="my-2">
                        <!-- Driver Type -->
                        <h6>Driver Type</h6>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="driver" id="withdriver" checked>
                            <label class="form-check-label small" for="withdriver">With Driver</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="driver" id="selfdrive">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="listing-section">
                        ...
                        @foreach ($cabPrices as $cab)
                            <div class="cab-card shadow">
                                <div class="row g-0">
                                    <div class="col-lg-8 cab-left">
                                        <div class="d-flex flex-wrap">
                                            <div class="col-4">
                                                <img src="https://transfer.easemytrip.com/assets/img/dezire.png"
                                                    style="height: 55px !important; width:auto;" alt="Toyota Etios"
                                                    class="cab-image">
                                            </div>
